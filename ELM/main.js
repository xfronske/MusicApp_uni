...
var $author$project$Main$Http_Loading = {$: 'Http_Loading'};
...
var $author$project$Main$reciever = _Platform_incomingPort('reciever', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$reciever($author$project$Main$Recv);
};
...
var $author$project$Main$getQuote = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotQuote, $author$project$Main$quoteDecoder),
			...
			case 'Send':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draft: 'requestToken'}),
					$author$project$Main$send(model.draft));
			default:
																			...
																			[
																				...
																				_List_fromArray(
																					[
																						$elm$html$Html$Attributes$class('dropdown-item'),
																						$elm$html$Html$Events$onClick(
																						$author$project$Main$TogglePage(3))
																					]),
																				_List_fromArray(
																					[
...
var $author$project$Main$GetMore = {$: 'GetMore'};
var $elm$html$Html$blockquote = _VirtualDom_node('blockquote');
var $author$project$Main$viewQuote = function (model) {
	var _v0 = model.httpState;
	switch (_v0.$) {
		case 'Http_Failure':
			return A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$GetMore)
							]),
						_List_fromArray(
							[
...
var $author$project$Main$pageQuote = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				switch (_v0) {
					...
					case 2:
						return A2(
							...
							_List_fromArray(
								[
									$author$project$Main$pageQuote(model)
								]));
					case 3:
						return A2(
							$elm$html$Html$div,
