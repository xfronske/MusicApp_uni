(function (scope) {
  ...
  function _VirtualDom_noJavaScriptOrHtmlJson(value) {
    return typeof _Json_unwrap(value) === "string" &&
      _VirtualDom_RE_js_html.test(_Json_unwrap(value))
      ? _Json_wrap(
          /**_UNUSED/''//*/ /**/ 'javascript:alert("This is an XSS vector. Please use ports or web components instead.")' //*/
        )
      : value;
  ...
  var $author$project$Login$init = function (_v0) {
    return _Utils_Tuple2({ loggedIn: false }, $elm$core$Platform$Cmd$none);
  };
  ...
  var $author$project$Login$sendMessage = _Platform_outgoingPort(
    "sendMessage",
    $elm$json$Json$Encode$string
  );
  var $author$project$Login$update = F2(function (msg, model) {
    return _Utils_Tuple2(model, $author$project$Login$sendMessage("login"));
  });
  ...
  var $elm$html$Html$Attributes$alt =
    $elm$html$Html$Attributes$stringProperty("alt");
  ...
  var $elm$html$Html$Attributes$attribute =
    $elm$virtual_dom$VirtualDom$attribute;
  var $elm$html$Html$br = _VirtualDom_node("br");
  var $elm$html$Html$button = _VirtualDom_node("button");
  var $elm$html$Html$Attributes$class =
  ...
  var $elm$html$Html$Attributes$id =
    $elm$html$Html$Attributes$stringProperty("id");
  ...
  var $author$project$Login$view = function (_v0) {
    return A2(
      $elm$html$Html$section,
      _List_fromArray([
        $elm$html$Html$Attributes$class(
          "hero is-fullheight is-default is-bold"
        ),
      ]),
      _List_fromArray([
        A2(
          $elm$html$Html$div,
          _List_fromArray([$elm$html$Html$Attributes$class("hero-head")]),
          _List_fromArray([
            A2(
              $elm$html$Html$nav,
              _List_fromArray([$elm$html$Html$Attributes$class("navbar")]),
              _List_fromArray([
                A2(
                  $elm$html$Html$div,
                  _List_fromArray([
        ...
        A2(
          $elm$html$Html$div,
          _List_fromArray([$elm$html$Html$Attributes$class("hero-body")]),
          _List_fromArray([
            A2(
              $elm$html$Html$div,
              _List_fromArray([
                            ...
                            A2(
                              ...
                              _List_fromArray([
                                ...
                                $elm$html$Html$Events$onClick(
                                  $author$project$Login$GoToMain
                                ),
                              ]),
                              _List_fromArray([
                                $elm$html$Html$text("Login with Spotify"),
                              ])
                            ),
                          ])
                        ),
        ...
        A2(
          ...
          _List_fromArray([$elm$html$Html$Attributes$class("footer")]),
          _List_fromArray([
            A2(
              $elm$html$Html$div,
              _List_fromArray([
                ...
                A2(
                  ...
                  _List_fromArray([
                    A2(
                      ...
                      _List_Nil,
                      _List_fromArray([$elm$html$Html$text("Klangkapsel")])
                    ),
                    ...
                    A2(
                      ...
                      _List_fromArray([
                        $elm$html$Html$Attributes$href(
                          "https://eremiyarifat.de"
                        ),
                      ]),
                      _List_fromArray([$elm$html$Html$text("Eremiya Rifat")])
                    ),
                    $elm$html$Html$text(" and Xaver "),
                    $elm$html$Html$text(". The source code is on "),
                    A2(
                      $elm$html$Html$a,
                      _List_fromArray([
                        $elm$html$Html$Attributes$href(
                          "https://github.com/xfronske/MusicApp_uni/"
                        ),
                      ]),
                      _List_fromArray([$elm$html$Html$text("GitHub")])
                    ),
                    $elm$html$Html$text(
                      ". The website content is made with Elm "
                    ),
                  ])
                ),
              ])
  ...
  var $author$project$Login$main = $elm$browser$Browser$element({
    init: $author$project$Login$init,
    subscriptions: $author$project$Login$subscriptions,
    update: $author$project$Login$update,
    view: $author$project$Login$view,
  });
  _Platform_export({
    Login: {
      init: $author$project$Login$main(
